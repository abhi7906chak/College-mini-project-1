...
def main(emotion):
    emotion = emotion.lower()  # Convert input to lowercase
    ...
    titles = [
        a.get_text() for a in soup.find_all("a", href=re.compile(r"/title/tt\d+/"))
    ]
    return titles
...
if __name__ == "__main__":
    ...
    if not movie_titles:
        ...
        max_titles = (
            14 if emotion in ["drama", "action", "comedy", "horror", "crime"] else 12
        )
